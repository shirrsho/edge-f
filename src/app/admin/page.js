        ...
        <div class="md:h-screen bg-white relative flex flex-col justify-center items-center">
            <div class="md:border md:border-gray-300 bg-white md:shadow-lg shadow-none rounded p-10" >
                <div class="flex flex-col items-center space-y-3">
                    ...
                    <p class="leading-normal">Use IIT provided Admin Code to login</p>
                </div>
                <form class="my-8">
                    <div class="relative mb-2">
                        <input id="email" class="w-full rounded px-3 border pt-3 pb-2 focus:outline-none input active:outline-none" type="text" autofocus />
                        <label for="email" class="label absolute mt-2 ml-3 leading-tighter text-gray-600 text-base cursor-text">Admin Code</label>
                    </div>
                    <div class="space-y-9 mt-10">
                        ...
                        <div class="text-sm">
                            ...
                            <a class="font-bold text-cyan-500" href="#">Request Code</a>
                        </div>
                        <div class="text-sm flex justify-between items-center float-right">
                            {/* <a class="font-bold text-blue-500 py-2 px-2 rounded -ml-2 hover:bg-blue-50 hover:text-blue-700" href="#">Create account</a> */}
                            <button class="py-2 px-6 rounded text-white btn bg-cyan-500 hover:bg-cyan-600">Login</button>
                        </div>
                    </div>
                </form>
            </div>
