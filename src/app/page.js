  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <div className="bg-white shadow w-full pt-5 pb-5 fixed flex items-center justify-center">
        ...
        <div className="relative max-w-md w-full flex space-x-5 z-10">
        ...
        <div className="flex-1 p-4 w-full md:w-1/2">
          ...
          <div className="mt-8 flex flex-wrap space-x-0 space-y-2 md:space-x-4 md:space-y-0">
            <div className="flex-1 bg-white p-4 shadow rounded-lg md:w-1/2">
              <h2 className="text-gray-500 text-lg font-semibold pb-1">Tracks</h2>
          ...
          <div className="relative max-w-md w-full mt-10 z-0">
            {/* <div className="absolute top-1 left-2 inline-flex items-center p-2">
                      <i className="fas fa-search text-gray-400"></i>
                  </div> */}
            <input className="w-full h-10 pl-10 pr-4 py-1 text-base placeholder-gray-500 border rounded-full focus:shadow-outline" placeholder="Search..." />
          </div>
